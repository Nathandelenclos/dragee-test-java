...
- Ce pom utilise des ranges Maven ([0,)) pour obtenir la dernière version disponible. Si la résolution échoue, remplacez la propriété fixentropy.version par une version explicite (ex: 1.2.3).
